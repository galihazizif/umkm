<?php $this->pageTitle = Yii::app()->name." - Reset Password UMKM"; ?>

<div class="row" style="margin-top: 125px;">

	<div class="offset4 span4">
		<p class="row">Untuk mereset password akun UMKM, masukkan email anda. Sebuah link akan dikirimkan ke email anda.</p>
