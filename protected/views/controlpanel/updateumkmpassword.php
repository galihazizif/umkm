...
<div class="modal-footer">
      <button type="button" id="xhrSubmitButton" onClick="xhrSubmitButton(this.id,this.value,this.name)" name="#password-form" value="<?php print $this->createUrl('controlpanel/updateumkmpassword')?>" class="btn btn-primary">Simpan</button>
</div>
<?php endif;?>
